...
const Servers = ({
  ...
  return (
    ...
    >
          ...
          <div className='flex flex-col gap-y-4 items-center justify-center'>
            {(() => {
              ...
              for (let index = 0; index < 10; index++) {
                loadingServers.push(<div key={index} className='animate-pulse rounded-full w-12 h-12 bg-[#2b2d31]'/>)
              }
      ...
      <div id="explore" className='rounded-full hover:rounded-xl bg-[#2b2d31] hover:bg-indigo-500 text-white transition duration-100 ease-linear cursor-pointer p-2 w-12 h-12 flex items-center justify-center peer/explore group'>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className='fill-current size-6'>
